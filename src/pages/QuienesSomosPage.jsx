...
export const QuienesSomosPage = () => {
  return (
    <div className='div-somos'>
        ...
        <hr />
        <h1 className='color-title'><b>Nuestra visión:</b></h1>
        <hr />
        <p>Nuestra visión Ser la principal tienda de ropa en nuestra ciudad, destacando por ofrecer una amplia variedad de prendas de alta 
            calidad y diseños únicos, a precios accesibles para todos los clientes. Queremos ser reconocidos como líderes en moda y estilo, brindando una experiencia de compra incomparable, que fomente la lealtad y satisfacción de nuestros clientes.
        </p>
        <hr />
